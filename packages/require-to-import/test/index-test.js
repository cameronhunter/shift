...
test(t => {
    ...
    const after = "import {b} from './a/b';\nimport {b as _b} from './b/b';\nconst A = b.c;\nconst B = _b.c;";
...
test(t => {
    const before = "const foo = require('foo-bar')('foo');";
    const after = "import fooBarFactory from 'foo-bar';\nconst foo = fooBarFactory('foo');";
...
*/
const expect = require('chai').expect;
const {getFocusedWidget} = require('nf-flow/focus'); // Foo
...
import {getFocusedWidget} from 'nf-flow/focus'; // Foo
import foo from 'foo';
